export default function Marquee({ text }: { text: string }) {
    return (
        <div className="relative w-full overflow-hidden bg-white py-8 flex border-y border-gray-200 z-20">
                    ...
                    <div key={i} className="flex items-center">
                        <span
                            ...
                            style={{
                                ...
                                color: i % 2 === 0 ? "transparent" : "#000000",
                                textShadow: i % 2 !== 0 ? "0 0 40px rgba(0, 240, 255, 0.4)" : "none"
                            }}
                        >
                            {text}
                        </span>
                        <span className="text-[4vw] px-12 text-black opacity-60">•</span>
                    </div>
                ))}
            </div>
        </div>
